    ...
    if profile:
        ...
        if not _music_sent:
            ...
            if _fan_mentioned_music:
                ...
                facts.append(f"URGENT MUSIC PUSH: You've been talking to this fan for a while and still haven't shared your music — make it happen in this response. Be creative and natural, not salesy. Examples of how to work it in: 'wait you haven't even heard my stuff yet omg', 'idk how we been talking this long and i never sent you this', 'ok hold on real quick i need you to do something for me', 'you been sleeping on me fr fr', 'ok i'm offended you haven't heard this yet lol'. Drop the link: {make_link('music', user_id)} and ask if they checked it out.")
